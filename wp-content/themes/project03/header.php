            ...
            <div class="top-header__wrap">
                ...
                <nav class="main-navigation">
                    <ul class="nav-list">
                        ...
                        <li class="nav-list__nav-item"><a href="/" class="nav-list__nav-item__nav-link">Новости
                                </a></li>
                        <li class="nav-list__nav-item"><a href="/stock" class="nav-list__nav-item__nav-link">Акции</a></li>
                        <li class="nav-list__nav-item"><a href="/about" class="nav-list__nav-item__nav-link">О сервисе</a>
                        </li>
                    </ul>
                </nav>
            </div>
